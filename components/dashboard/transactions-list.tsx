    ...
    <>
      {transactions && transactions.length > 0 ? (
        ...
        <EmptyPlaceholder>
          ...
          <EmptyPlaceholder.Title>No transactions yet!</EmptyPlaceholder.Title>
          <EmptyPlaceholder.Description>
            You don&apos;t have any transactions yet. Start your marketing
            campaign to get your first order.
          </EmptyPlaceholder.Description>
          <Link href="/guides">
